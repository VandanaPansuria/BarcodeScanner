...
open class MRZ: NSObject {
    ...
    public var documenNumer: String = ""
    ...
    public init(scan: String, debug: Bool = false) {
        ...
        for line in lines {
           // print(line)
            ...
            print(cleaned)
            print(cleaned.characters.count)
            if cleaned.characters.count > 43 || cleaned.characters.count > 29{
        ...
        } else if longLines.count == 3{
            processline(l1: longLines[longLines.count-3], l2: longLines[longLines.count-2], l3: longLines[longLines.count-1])
    ...
    */
    ...
    fileprivate func processline(l1: String, l2: String, l3 : String) {
        
        let line1 = MRZ.cleanup(line: l1)
        let line2 = MRZ.cleanup(line: l2)
        let line3 = MRZ.cleanup(line: l3)
        ...
        personalNumber =  line1.subString(5, to: 13).toNumber()
        debugLog("personal number : \(personalNumber)")
        let personalNumberValidation = line2.subString(14, to: 14).toNumber()
     
            
            passportNumber = line1.subString(5, to: 6) + line1.subString(7, to: 13).toNumber()
            debugLog("passportNumber : \(passportNumber)")
            let passportNumberCheck = line2.subString(6, to: 14).toNumber()
        ...
        // Line 3 parsing
        let name = line3.subString(0, to: 29).replace(target: "0", with: "O")
        var nameArray = name.components(separatedBy: "<<")
        print(nameArray)
        lastName = nameArray[0].replace(target: "<", with: " ")
        print(lastName)
